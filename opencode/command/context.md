...
<critical_rules priority="absolute" enforcement="strict">
  ...
  <rule id="lazy_load">
    ALWAYS read required context files from /home/senohebat/.config/opencode/context/core/context-system/ BEFORE executing operations.
  </rule>
</critical_rules>
...
**`/context migrate`**
- Copy project-intelligence from global (`~/.config/opencode/context/`) to local (`/home/senohebat/.config/opencode/context/`)
...
**All files located in**: `/home/senohebat/.config/opencode/context/core/context-system/`
...
<subagent_routing>
  ...
  <route operations="harvest|extract|organize|update|error|create|migrate" to="ContextOrganizer">
    ...
    Subagent loads: Required context files from /home/senohebat/.config/opencode/context/core/context-system/
...
### Structure
```
/home/senohebat/.config/opencode/context/core/context-system/
...
```bash
/context migrate
# Copies project-intelligence from ~/.config/opencode/context/ to /home/senohebat/.config/opencode/context/
...
**Context System Location**: `/home/senohebat/.config/opencode/context/core/context-system/`
