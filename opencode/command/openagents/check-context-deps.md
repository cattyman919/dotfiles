...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `/home/senohebat/.config/opencode/context/` (direct path references)
    - `@/home/senohebat/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f /home/senohebat/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → /home/senohebat/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read /home/senohebat/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\/home/senohebat/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `/home/senohebat/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@/home/senohebat/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "/home/senohebat/.config/opencode/context/core/" (direct paths)
       - "@/home/senohebat/.config/opencode/context/" (@ references)
    ...
    4. For each context file in /home/senohebat/.config/opencode/context/core/:
...
✓ /home/senohebat/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ /home/senohebat/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `/home/senohebat/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
