...
**Purpose**: Copy context files from global (`~/.config/opencode/context/`) to local (`/home/senohebat/.config/opencode/context/`) so they're project-specific and git-committed.
...
Local location: /home/senohebat/.config/opencode/context/
...
If local `/home/senohebat/.config/opencode/context/project-intelligence/` already exists:
...
Will copy to:   /home/senohebat/.config/opencode/context/project-intelligence/
...
**Actions on approval:**
1. Create `/home/senohebat/.config/opencode/context/project-intelligence/` if it doesn't exist
...
Copied 3 files to /home/senohebat/.config/opencode/context/project-intelligence/
...
**Permission denied:**
```
Error: Cannot write to /home/senohebat/.config/opencode/context/project-intelligence/
...
- Context path resolution: `/home/senohebat/.config/opencode/context/core/system/context-paths.md`
