...
**Index Location**: `/home/senohebat/.config/opencode/context/navigation.md` - Quick map of all contexts
...
**Central Index**: `/home/senohebat/.config/opencode/context/navigation.md` - Ultra-compact map of all contexts
...
All files are in `/home/senohebat/.config/opencode/context/core/` with organized subfolders:
...
- Load `/home/senohebat/.config/opencode/context/navigation.md`
...
### /home/senohebat/.config/opencode/context/core/standards/security-patterns.md
- Error handling
- Security patterns
- Common code patterns

### /home/senohebat/.config/opencode/context/core/standards/code-analysis.md
- Analyzing codebase patterns
- Investigating bugs
- Evaluating architecture

### /home/senohebat/.config/opencode/context/core/workflows/task-delegation-basics.md
- Delegating to general agent
- Creating task context
- Multi-file coordination

### /home/senohebat/.config/opencode/context/core/workflows/feature-breakdown.md
- Tasks with 4+ files
- Estimated effort >60 minutes
- Complex dependencies

### /home/senohebat/.config/opencode/context/core/workflows/session-management.md
- Session lifecycle
- Cleanup procedures
- Session isolation
