...
```bash
npx ts-node /home/senohebat/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/home/senohebat/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
