...
- Answer is in `/home/senohebat/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/home/senohebat/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/home/senohebat/.config/opencode/context/core/workflows/task-delegation-basics.md`
