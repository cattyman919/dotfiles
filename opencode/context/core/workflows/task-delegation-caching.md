...
├── .cache/
│   ├── test-coverage.md (cached from /home/senohebat/.config/opencode/context/)
│   ├── code-quality.md
│   └── code-review.md
...
```json
{
  ...
  "cache": {
    "test-coverage.md": {
      "source": "/home/senohebat/.config/opencode/context/core/standards/test-coverage.md",
...
IF cache exists AND cache is valid:
  ...
  SKIP re-reading from /home/senohebat/.config/opencode/context/
ELSE:
  READ from /home/senohebat/.config/opencode/context/
  CACHE the file
```
