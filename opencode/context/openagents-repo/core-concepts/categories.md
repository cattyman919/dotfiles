...
/home/senohebat/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /home/senohebat/.config/opencode/context/{category}
...
```bash
cat > /home/senohebat/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/home/senohebat/.config/opencode/context/{category}/
...
Loads: `/home/senohebat/.config/opencode/context/ui/web/react-patterns.md`
