...
glob(pattern="**/*.md", path="/home/senohebat/.config/opencode/context")

// 2. Use grep to search content
grep(pattern="registry", path="/home/senohebat/.config/opencode/context")

// 3. Read relevant files directly
read(filePath="/home/senohebat/.config/opencode/context/openagents-repo/core-concepts/registry.md")
```
