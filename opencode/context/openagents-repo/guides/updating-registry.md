...
**Context** (`/home/senohebat/.config/opencode/context/category/your-context.md`):
```yaml
---
...
```json
{
  ...
  "type": "context",
  "path": "/home/senohebat/.config/opencode/context/core/workflows/session-management.md",
  "aliases": [
    "workflows-sessions",
    "sessions"
  ],
