...
| **Context files** | `/home/senohebat/.config/opencode/context/` |
...
| **New context** | `/home/senohebat/.config/opencode/context/{category}/{name}.md` |
...
```
/home/senohebat/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/home/senohebat/.config/opencode/context/core/standards/code-quality.md`
- `/home/senohebat/.config/opencode/context/ui/web/react-patterns.md`
- `/home/senohebat/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /home/senohebat/.config/opencode/context/{category}/

# All context
find /home/senohebat/.config/opencode/context -name "*.md"
```
