...
**Core Standards**:
- `/home/senohebat/.config/opencode/context/core/standards/code.md` → Modular, functional code patterns
- `/home/senohebat/.config/opencode/context/core/standards/tests.md` → Testing requirements and TDD
- `/home/senohebat/.config/opencode/context/core/standards/docs.md` → Documentation standards
- (example: `/home/senohebat/.config/opencode/context/core/standards/patterns.md`) → Error handling, security patterns

**Core Workflows**:
- (example: `/home/senohebat/.config/opencode/context/core/workflows/delegation.md`) → Delegation process
- (example: `/home/senohebat/.config/opencode/context/core/workflows/task-breakdown.md`) → Task breakdown methodology
- (example: `/home/senohebat/.config/opencode/context/core/workflows/review.md`) → Code review guidelines
