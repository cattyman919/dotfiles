...
```
/home/senohebat/.config/opencode/context/project-intelligence/
...
- `/home/senohebat/.config/opencode/context/core/standards/project-intelligence.md` (standards and patterns)
- `/home/senohebat/.config/opencode/context/core/system/context-guide.md` (context loading)

See `/home/senohebat/.config/opencode/context/core/context-system.md` for the broader context architecture.
...
**Management Guide**: See `/home/senohebat/.config/opencode/context/core/standards/project-intelligence-management.md` for complete lifecycle management including:
...
See `/home/senohebat/.config/opencode/context/core/standards/project-intelligence.md` for the standard itself.
